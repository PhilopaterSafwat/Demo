...
export default function RecentProduct() {
    ...
    let { DisplayCart,addProductTOCart, AddProductToWishlist, getWishlist, wishlist, RemoveProductFromWishlist } = useContext(CartContext);
    ...
    return <>
        {isLoading ? <div role="status" className='flex items-center justify-center'>
            ...
            {data.map((Product, index) =>
                <div className='md:w-1/2 lg:w-1/4 product relative' key={index}>
                    <div className='p-5'>
